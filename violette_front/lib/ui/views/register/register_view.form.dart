...
final Map<String, String? Function(String?)?> _RegisterViewTextValidations = {
  ...
  PasswordConfirmationValueKey: null,
};
...
mixin $RegisterView {
  ...
  TextEditingController get passwordConfirmationController =>
      _getFormTextEditingController(PasswordConfirmationValueKey);

  FocusNode get firstNameFocusNode => _getFormFocusNode(FirstNameValueKey);
  FocusNode get lastNameFocusNode => _getFormFocusNode(LastNameValueKey);
  FocusNode get emailFocusNode => _getFormFocusNode(EmailValueKey);
  FocusNode get passwordFocusNode => _getFormFocusNode(PasswordValueKey);
  FocusNode get passwordConfirmationFocusNode =>
      _getFormFocusNode(PasswordConfirmationValueKey);
...
extension ValueProperties on FormStateHelper {
  ...
  String? get passwordConfirmationValue =>
      this.formValueMap[PasswordConfirmationValueKey] as String?;
  ...
  set passwordConfirmationValue(String? value) {
    this.setData(
      this.formValueMap..addAll({PasswordConfirmationValueKey: value}),
    );

    if (_RegisterViewTextEditingControllers.containsKey(
        PasswordConfirmationValueKey)) {
      _RegisterViewTextEditingControllers[PasswordConfirmationValueKey]?.text =
          value ?? '';
    }
  }
  ...
  bool get hasPasswordConfirmation =>
      ...
      (passwordConfirmationValue?.isNotEmpty ?? false);
  ...
  bool get hasPasswordConfirmationValidationMessage =>
      this.fieldsValidationMessages[PasswordConfirmationValueKey]?.isNotEmpty ??
      false;
  ...
  String? get passwordConfirmationValidationMessage =>
...
extension Methods on FormStateHelper {
  ...
  void validateForm() {
    this.setValidationMessages({
      ...
      PasswordConfirmationValueKey:
          getValidationMessage(PasswordConfirmationValueKey),
    });
  }
}
