...
class UtilisateursApi {
  ...
  const UtilisateursApi(this._dio, this._serializers);
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [VioletteUserDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<VioletteUserDto>> apiUsersByFirebaseFirebaseUidGet({ 
    ...
    final _path = r'/api/users/by-firebase/{firebaseUid}'.replaceAll('{' r'firebaseUid' '}', encodeQueryParameter(_serializers, firebaseUid, const FullType(String)).toString());
    ...
    VioletteUserDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(VioletteUserDto),
      ) as VioletteUserDto;
    ...
    return Response<VioletteUserDto>(
      data: _responseData,
  ...
  /// Returns a [Future] containing a [Response] with a [VioletteUserDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<VioletteUserDto>> apiUsersGet({ 
    int? page = 0,
    int? size = 20,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [VioletteUserDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<VioletteUserDto>> apiUsersIdGet({ 
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AuthenticatedUserDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AuthenticatedUserDto>> apiUsersMeGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    AuthenticatedUserDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AuthenticatedUserDto),
    ...
    return Response<AuthenticatedUserDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [VioletteUserDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<VioletteUserDto>> apiUsersMeProfileGet({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/users/me/profile';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [VioletteUserDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<VioletteUserDto>> apiUsersPost({ 
